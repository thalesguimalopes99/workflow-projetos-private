...
description: Create visually distinctive, high-impact frontend interfaces that avoid generic "AI slop" aesthetics. Use when building landing pages, marketing sites, portfolios, dashboards, or any web UI where the user asks for "modern", "distinctive", "eye-catching", or non-generic design. Applies a four-vector approach — typography (extreme weights), color/theme (cohesive cultural references), motion (orchestrated page-load choreography), and backgrounds (atmospheric layered depth).
---
