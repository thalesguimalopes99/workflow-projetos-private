...
**Purpose:** Write a Video Sales Letter script using the RMBC method with layered persuasion psychology.
...
Study these real-world champion VSLs before writing:

1. **"The End of America"** (Stansberry Research, Mike Palmer) — 60-min fear-driven VSL, proof-heavy, generated $100M+
2. **"Patriot Health Alliance"** (Stefan Georgi) — RMBC textbook execution, supplement VSL with strong mechanism reveal
3. **"Flat Belly Fix"** (Todd Lamb / Stefan Georgi) — Short-form health VSL, tight RMBC, massive cold traffic winner
4. **"Video Secrets"** (Jon Benson) — Pioneer of the text-on-screen VSL format, conversational micro-commitment style
5. **"The Oxford Club Pitch"** (Agora Financial) — Long-form financial VSL, authority + social proof stacking
...
1. Map Cialdini's principles into the VSL structure:
   - **Relate section:** Liking (shared struggle), Unity (shared identity)
   - **Mechanism section:** Authority (science, credentials), Commitment (small agreements)
   - **Benefits section:** Social Proof (testimonials), Reciprocity (free insights)
   - **Close section:** Scarcity (limited time/spots), Consistency (they already agreed)
2. Apply Blair Warren's 5 levers:
   - Relate = Justify failures + Allay fears
   - Mechanism = Confirm suspicions + Throw rocks at enemies
   - Benefits = Encourage dreams
3. Ensure each RMBC section activates at least 2 psychological principles
4. Document the persuasion architecture
...
| RMBC Section | Cialdini Principles | Warren Levers |
|--------------|--------------------|--------------  |
| Relate | {principles} | {levers} |
| Mechanism | {principles} | {levers} |
...
- [ ] Psychological Layer applied — Cialdini principles mapped per RMBC section
