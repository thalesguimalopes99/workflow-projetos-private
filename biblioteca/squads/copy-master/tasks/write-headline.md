...
**Purpose:** Create compelling headlines calibrated to the prospect's awareness level with deep persuasion psychology.
...
Study these real-world champion headlines before writing:

1. **"They Laughed When I Sat Down at the Piano — But When I Started to Play!"** (John Caples, U.S. School of Music) — Story-driven curiosity for unaware audiences
2. **"Do You Make These Mistakes in English?"** (Sherwin Cody) — Question + implied flaw for problem-aware audiences
3. **"How to Win Friends and Influence People"** (Dale Carnegie) — Benefit-driven how-to for solution-aware audiences
4. **"The Lazy Man's Way to Riches"** (Joe Karbo) — Counterintuitive promise combining ease + outcome
5. **"Amazing Secret Discovered by 37-Year-Old Mom Exposed By Top Doctors"** (Agora Financial) — Specificity + authority + curiosity stack
...
1. Tag each headline with the primary Cialdini principle it activates:
   - Reciprocity, Commitment/Consistency, Social Proof, Authority, Liking, Scarcity, Unity
2. Check each headline against Blair Warren's One Sentence Persuasion:
...
3. Ensure at least 3 different Cialdini principles are represented across the 10 headlines
4. Mark which Warren lever each headline pulls
...
| Rank | Headline | Formula | Specificity | Curiosity | Relevance | Believability | Total | Cialdini Principle | Warren Lever |
|------|----------|---------|-------------|-----------|-----------|---------------|-------|--------------------|--------------|
| 1 | {headline} | {formula} | X | X | X | X | XX | {principle} | {lever} |
...
1. {headline} — {formula used} — {Cialdini principle}
...
```
...
- [ ] Psychological Layer applied — Cialdini principles tagged per headline
- [ ] Blair Warren levers identified per headline
