...
**Purpose:** Write landing page copy that creates an unstoppable slippery slide from headline to CTA, reinforced by persuasion psychology.
...
Study these real-world champion landing pages before writing:

1. **Basecamp's Homepage** — Simple, benefit-driven, social proof heavy, conversational tone, single CTA repeated
2. **Ramit Sethi's Long-Form Sales Pages** (IWT) — Proof-dense, FAQ-driven objection handling, personality voice throughout
3. **ClickFunnels Opt-In Pages** (Russell Brunson) — Minimal copy, clear hook, "free + shipping" offer framing
4. **Agora Financial Advertorials** — Story-driven landing pages disguised as editorial content, massive cold-traffic converters
5. **Joanna Wiebe's Copyhackers Pages** — CRO-optimized copy, micro-copy mastery, button text A/B testing discipline
...
1. Map Cialdini's principles into page sections:
   ...
   - **Solution:** Commitment (small agreement before the big ask)
   - **Proof:** Social Proof (testimonials, logos, numbers)
   - **Offer:** Reciprocity (bonus value exceeds price) + Scarcity (limited offer)
   - **CTA:** Unity ("join us") + Commitment (button text as micro-commitment)
2. Apply Blair Warren's levers:
   - Hero section: Encourage dreams or Confirm suspicions
   - Problem section: Justify failures
   - Solution section: Allay fears
   - CTA section: Encourage dreams (future state after clicking)
...
- **Cialdini principles per section:** {summary}
```
...
- [ ] Blair Warren levers identified per section
